...
<b>🔸Last Update : <a href='https://telegram.me/mhd_thanzeer'> 26 - September - 2021 || 11:00 PM</a></b>"""
    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<b>Something Went Worng Contact My Owner </b> <b><a href='http://t.me/mhd_thanzeer'>𝗠𝗛𝗗_𝗧𝗛𝗔𝗡𝗭𝗘𝗘𝗥</a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                          InlineKeyboardButton("➡️  JOIN MY GROUP  ⬅️", url=f"https://t.me/{Var.UPDATES_CHANNEL}")
                            ]]
                    ),
                    parse_mode="markdown"
                )
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Something Went Worng..!! Contact Me __ [𝗠𝗛𝗗_𝗧𝗛𝗔𝗡𝗭𝗘𝗘𝗥](http://t.me/mhd_thanzeer)",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
